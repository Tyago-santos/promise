...
export const contacts: ContactType[] = [
  {
    ...
    online: true,
    mensagens: [
      { id: 'm1', text: 'Oi, consegui parar um pouco agora. Como foi seu dia at� aqui?', position: 'left', date: new Date() },
  ...
  },
  {
    ...
    online: true,
    mensagens: [
      { id: 'm1', text: 'Passei no mercado e lembrei daquela lista que voc� mandou.', position: 'left', date: new Date() },
  ...
  },
  {
    ...
    online: true,
    mensagens: [
      { id: 'm1', text: 'Acabei de sair da reuni�o, foi mais longa do que eu esperava.', position: 'left', date: new Date() },
      { id: 'm2', text: 'Imagino. Quando puder, me d� um resumo do que ficou decidido.', position: 'right', date: new Date() },
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    mensagens: [
      ...
      { id: 'm2', text: 'Pode sim, me passa o hor�rio certinho que eu confirmo.', position: 'right', date: new Date() },
    ],
  },
  {
    id: 6,
    ...
    online: false,
    mensagens: [
      { id: 'm1', text: 'Estou quase chegando, o tr�nsito abriu agora.', position: 'left', date: new Date() },
  ...
  },
  {
    ...
    online: false,
    mensagens: [
      { id: 'm1', text: 'Boa noite! Amanh� tenho um hor�rio mais livre pra falar.', position: 'left', date: new Date() },
  ...
  },
  {
    ...
    online: false,
    mensagens: [
      { id: 'm1', text: 'Voc� acha melhor fechar isso hoje ou deixar pra amanh�?', position: 'left', date: new Date() },
  ...
  },
  {
    ...
    online: false,
    mensagens: [
      { id: 'm1', text: 'J� subi no drive e organizei por pastas pra facilitar.', position: 'left', date: new Date() },
      { id: 'm2', text: '�timo, vou conferir mais tarde e te retorno.', position: 'right', date: new Date() },
    ],
  },
];
